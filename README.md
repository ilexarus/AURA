...
## Исправление интерфейса 0.5.6

В редакторе команд выровнены кнопки «Записать», «Добавить», «Отмена» и «Сохранить». Нижняя панель теперь остаётся внутри окна при масштабировании Windows.
